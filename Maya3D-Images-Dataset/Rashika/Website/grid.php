		...
		<div class="row">
			...
			<div class="col-md-9 col-lg-9 col-sm-9">
				<div class="row" id="res">
					...
					{
						echo "<script>console.log( 'Debug Objects: " . $result['ObjectPath'] . "' );</script>";
						...
						<div class="col-md-4 col-lg-4 col-sm-4">
							<div class="col-md-12">
								<p class="text-center">
									<?php $image= explode('/',$result['ObjectPath'])
									?>
									<a href="<?php echo $url; ?>"><img src="<?php echo $result['ObjectPath'] ?>" class="img-responsive img-thumbnail">
										</a>
								</p>
							</div>
						</div>
